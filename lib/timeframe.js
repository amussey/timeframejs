		...
		for (var c = 0; c < this.categories.length; c++) {
			...
			for (var s1 = 0; s1 < category.spans.length; s1++) {
				...
				for (var s2 = 0; s2 < s1; s2++) {
					if (
						(category.spans[s1].start >= category.spans[s2].start && category.spans[s1].start < category.spans[s2].end && category.spans[s1].level == category.spans[s2].level) ||
						(category.spans[s1].end >= category.spans[s2].start && category.spans[s1].end < category.spans[s2].end && category.spans[s1].level == category.spans[s2].level)) {
